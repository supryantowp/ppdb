        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-cool-facts-area text-center mb-100 wow fadeInUp" data-wow-delay="250ms">
                    <div class="icon">
                        <img src="{{asset('assets/front/img/core-img/docs.png')}}" alt="">
                    </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-cool-facts-area text-center mb-100 wow fadeInUp" data-wow-delay="500ms">
                    <div class="icon">
                        <img src="{{asset('assets/front/img/core-img/star.png')}}" alt="">
                    </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-cool-facts-area text-center mb-100 wow fadeInUp" data-wow-delay="750ms">
                    <div class="icon">
                        <img src="{{asset('assets/front/img/core-img/events.png')}}" alt="">
                    </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-cool-facts-area text-center mb-100 wow fadeInUp" data-wow-delay="1000ms">
                    <div class="icon">
                        <img src="{{asset('assets/front/img/core-img/earth.png')}}" alt="">
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="250ms">
                    ...
                    <div class="events-thumb">
                        <img src="{{asset('assets/front/img/bg-img/e1.jpg')}}" alt="">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="500ms">
                    <!-- Events Thumb -->
                    <div class="events-thumb">
                        <img src="{{asset('assets/front/img/bg-img/e2.jpg')}}" alt="">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="750ms">
                    <!-- Events Thumb -->
                    <div class="events-thumb">
                        <img src="{{asset('assets/front/img/bg-img/e3.jpg')}}" alt="">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="250ms">
                    <img src="{{asset('assets/front/img/blog-img/1.jpg')}}" alt="">
                    <!-- Blog Content -->
            ...
            <div class="col-12 col-md-6">
                <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                    <img src="{{asset('assets/front/img/blog-img/2.jpg')}}" alt="">
                    <!-- Blog Content -->
                    <div class="blog-content">
                        <a href="#" class="blog-headline">
                            <h4>English Grammer</h4>
