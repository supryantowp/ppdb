    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Access Menu</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mt-0 header-title">Access Menu</h4>
                <p class="text-muted m-b-30 font-14">Berikut adalah data seluruh access menu</p>

                <div class="card-actions ">
                    <a class='btn btn-primary float-left' href="{{ route('access-menu.create') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-inline-flex">
                                        <a href="{{ route('access-menu.edit', ['access_menu' => $item->id]) }}"
                                            class="btn btn-icon btn-warning mr-2"><i
                                                class="mdi mdi-tooltip-edit"></i></a>

                                        <form action="{{route('access-menu.destroy', ['access_menu' => $item->id])}}"
